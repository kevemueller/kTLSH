...
/**
 * A TLSH digester for window size of 8 bytes.
 * 
 * @author keve
 *
 */
public final class TLSHDigest8 extends AbstractTLSHDigest {
    /**
     * The supported window length.
     */
    public static final int WINDOW_LENGTH = 8;
    /**
     * Hold the lag window of 7 bytes.
     */
    private long lag;

    /**
     * Construct the instance with window length 8.
     * 
     * @param bucketCount    the number of buckets (128|256)
     * @param checkSumLength the number of checksum bytes (1|3)
     */
    public TLSHDigest8(final int bucketCount, final int checkSumLength) {
    ...
    public void update(final ByteBuffer buf) {
        ...
        while (buf.hasRemaining()) {
            ...
            if (count >= windowLength) {
                ...
                aBucket[sMapping(237 /* T[53] */, l0, l1, l7)]++;
                aBucket[sMapping(214 /* T[59] */, l0, l2, l7)]++;
                aBucket[sMapping(227 /* T[61] */, l0, l3, l7)]++;
                aBucket[sMapping(22 /* T[67] */, l0, l4, l7)]++;
                aBucket[sMapping(175 /* T[71] */, l0, l5, l7)]++;
                aBucket[sMapping(5 /* T[73] */, l0, l6, l7)]++;
            }
            l7 = l6;
            l6 = l5;
            l5 = l4;
        ...
        lag = l7 << 48 | l6 << 40 | l5 << 32 | l4 << 24 | l3 << 16 | l2 << 8 | l1;
    }
