...
/**
 * A TLSH digester for window size of 4 bytes.
 * 
 * @author keve
 *
 */
public final class TLSHDigest4 extends AbstractTLSHDigest {
    /**
    ...
    /**
     * Hold the lag window of 3 bytes.
     */
    private int lag;

    /**
     * Construct the instance with window length 4.
     * 
     * @param bucketCount    the number of buckets (128|256)
     * @param checkSumLength the number of checksum bytes (1|3)
     */
    public TLSHDigest4(final int bucketCount, final int checkSumLength) {
    ...
    protected int[] getLag() {
        return new int[] {lag & 0xFF, lag >>> 8 & 0xFF, lag >>> 16 & 0xFF};
    }
}
